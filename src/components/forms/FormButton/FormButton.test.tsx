...
describe('FormButton Component', () => {
    ...
    test('applies custom class names', () => {
        render(<FormButton type="submit" className="custom-class">Submit</FormButton>);
    ...
    test('applies custom variant', () => {
        render(<FormButton type="button" variant="success">Success Button</FormButton>);
    ...
    test('applies inverted styles', () => {
        render(<FormButton type="button" inverted>Inverted Button</FormButton>);
    ...
    test('calls onClick when clicked', () => {
        ...
        render(<FormButton type="button" onClick={handleClick}>Clickable</FormButton>);
