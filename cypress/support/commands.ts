...
Cypress.Commands.add('fillPasswordForm', function(currentPassword: string, newPassword: string, confirmPassword: string): Cypress.Chainable<null> {
...
Cypress.Commands.add('mockPasswordChange', function(options: { 
  success: boolean; 
  errorMessage?: string;
  statusCode?: number;
}): Cypress.Chainable<null> {
  const { success, errorMessage = 'Current password is incorrect', statusCode = 401 } = options;
...
Cypress.Commands.add('mockAccountDeletion', function(options: {
  success: boolean; 
  errorMessage?: string;
  statusCode?: number;
}): Cypress.Chainable<null> {
